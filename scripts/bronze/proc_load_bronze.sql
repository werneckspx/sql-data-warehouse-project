...
-- Descrição:
--   Este script define a procedure bronze.load_bronze, responsável por carregar
--   dados brutos das fontes CRM e ERP para as tabelas da camada Bronze do Data Warehouse.
--   O processo inclui truncamento das tabelas e carga dos arquivos CSV correspondentes,
--   além de registrar o tempo de execução de cada etapa.
--
-- Objetivo:
--   Automatizar o processo de ingestão dos dados brutos para a camada Bronze,
--   garantindo que as tabelas estejam sempre atualizadas com os dados mais recentes.
--
-- Tabelas envolvidas:
